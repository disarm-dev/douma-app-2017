<template>
  <div>
    ...
    <md-list>
      <md-list-item v-for="cluster in $store.state.irs_record.clusters" @click.native="$router.push({name: 'irs_record:cluster:view', params: {cluster_id: cluster.id}})">
    ...
    <md-button @click.native="$store.dispatch('irs_record:seed_local_data')" class='md-accent'>SEED LOCAL</md-button>
  </div>
</template>
