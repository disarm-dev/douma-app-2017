...
import {aggregate_for_pie_chart} from '../../lib/aggregate_data_for_chart'

/**
 * Prepare and aggregate data for pie chart
 * @param responses
 * @param targets
 * @param aggregations
 * @param options
...
export default function get_data({responses, targets, aggregations, options}) {
    ...
    return aggregate_for_pie_chart({binned_responses, options, aggregations, targets})
  }
