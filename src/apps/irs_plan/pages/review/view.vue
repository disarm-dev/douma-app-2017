<template>
  <div>
    <div class='container'>
      ...
      <p>This page shows there are {{$store.state.irs.clusters.length}} Clusters already created for demo instance <i>{{$store.state.meta.demo_instance_id}}</i>.</p><p>If you want to redo the clustering procedure, click the 'REDO' button below.</p>
  ...
  export default {
    ...
    methods: {
      redo_clustering() {
        ...
        this.$store.dispatch('irs:delete_clusters').then(() => {
          this.$store.commit
