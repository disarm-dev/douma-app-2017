export default [
  ...
  },
  {
    name: 'total_sprayed',
    fn: (f) => {
      if (f.any_structures_unsprayed === 'no') {
  ...
  },
  {
    ...
    fn: (f) => {
      if (f.any_structures_unsprayed === 'yes') {
        return  f.number_structures_total === (f.number_of_structures_sprayed + f.n_rooms_baby + f.n_rooms_food + f.n_rooms_funeral + f.n_rooms_kitchen + f.n_rooms_locked + f.n_rooms_material + f.n_rooms_nobody + f.n_rooms_other + f.n_rooms_patient + f.n_rooms_refused)
      }
    },
